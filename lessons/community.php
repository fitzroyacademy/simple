...
<div class="segments">
	...
	<div class="segment segment_resources" id="resources">
		...
		<div class="youtube" id="4cmrsp7NdxU"></div>
		<div class="resources">
			<a class="resource" href="https://docs.google.com/document/d/14xU0DMYvk_x6oZQpOk0_Kqnl-7p4EOGsP0v26X_bb-0/edit?usp=sharing" target="_blank">
				<i class="far fa-file-alt"></i>
				<h4>Community integration worksheet - Blank</h4>
				<p>This is the blank worksheet that Jenny uses to help you think about your position relative to the community you work with.</p>
			</a>
			<a class="resource" href="https://docs.google.com/document/d/1XWxjlGVs0Ep2kFmteXijoLoYbU4hn4VIuYYqJvikpkg/edit?usp=sharing" target="_blank">
				<i class="far fa-file-alt"></i>
				<h4>'Maternal and child health care program in Togo' - Lesson example.</h4>
				<p>This is the example of Jenny's own work that she takes you through during this lesson.</p>
			</a>
		</div>
	</div>

	<div class="segment segment_lesson" id="lesson">
		<h2><span class="no">1</span> Be humble.</h2>
		<div class="youtube" id="wTn9tk3qz68"></div>
		<p>Before we even start working within a community, we first need to make sure we are mindful of our position relative to that community. Jenny takes us through a process that helps us be humble and remember that we are not the experts of a commnuity's experiences.</p>
	</div>
	...
	<div class="segment segment_lesson">
		<h2><span class="no">3</span> Act.</h2>
		<div class="youtube" id="nuZ17Bcf7bw"></div>
		<p>Finally, now that you have gathered useful information from the community, it's time to act. Jenny shows you how to feed the information back to the community and keep them involved as you work with them.</p>
	</div>
